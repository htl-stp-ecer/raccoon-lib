...
# When LIBSTP_STUBGEN is set, skip all imports and side effects.
# pybind11-stubgen imports individual C++ submodules directly and does not
# need the full import chain — which would trigger LcmReader's background
# thread and raccoon::Transport connections that segfault without hardware.
if _os.environ.get("LIBSTP_STUBGEN"):
    __all__: list[str] = []
