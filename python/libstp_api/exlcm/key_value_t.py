...
class key_value_t(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(key_value_t._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != key_value_t._get_packed_fingerprint():
            raise ValueError("Decode error")
        return key_value_t._decode_one(buf)
    ...
    def _get_hash_recursive(parents):
        if key_value_t in parents: return 0
    ...
    def _get_packed_fingerprint():
        if key_value_t._packed_fingerprint is None:
            key_value_t._packed_fingerprint = struct.pack(">Q", key_value_t._get_hash_recursive([]))
        return key_value_t._packed_fingerprint
    _get_packed_fingerprint = staticmethod(_get_packed_fingerprint)

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", key_value_t._get_packed_fingerprint())[0]
