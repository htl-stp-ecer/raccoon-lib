...
namespace libstp::ahrs
{
    ...
    {
        throw std::runtime_error("Calibration is not implemented yet.");
    ...
    {
        throw std::runtime_error("getSensorReadings is not implemented yet.");
