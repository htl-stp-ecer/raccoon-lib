...
void init_linear_motion(py::module_& m)
{
    ...
    py::class_<LinearMotionTelemetry>(m, "LinearMotionTelemetry")
        ...
        .def_readonly("setpoint_position_m", &LinearMotionTelemetry::setpoint_position_m)
        .def_readonly("setpoint_velocity_mps", &LinearMotionTelemetry::setpoint_velocity_mps)
