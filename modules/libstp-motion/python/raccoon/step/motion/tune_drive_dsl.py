...
class TuneDriveBuilder(StepBuilder):
    ...
    def distances_cm(self, value: list[float] | None):
        self._distances_cm = value
        return self

    def speeds(self, value: list[float] | None):
        self._speeds = value
        return self
...
def tune_drive(distances_cm: list[float] | None = None, speeds: list[float] | None = None, csv_dir: str = '/tmp/drive_telemetry', axis: str = 'forward', settle_time: float = 1.5, timeout: float = 15.0):
    """
