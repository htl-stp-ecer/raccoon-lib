...
#include "device/two_wheeled/two_wheeled_device.h"
...
namespace libstp::device::two_wheeled
{
    ...
    {
        const float vWheelMax = 2.0f * M_PIf * wheelRadius * MAX_MOTOR_SPEED / ticksPerRevolution;
    ...
    void TwoWheeledDevice::applyKinematicsModel(const datatype::AbsoluteSpeed& speed)
    {
        ...
        leftMotor.setSpeed(static_cast<int>(leftMotorCmdTicks));
        rightMotor.setSpeed(static_cast<int>(rightMotorCmdTicks));
    }
