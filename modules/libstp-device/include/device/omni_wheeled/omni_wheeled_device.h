...
namespace libstp::device::omni_wheeled
{
    ...
    {
    public:
        hal::motor::Motor frontLeftMotor;
        hal::motor::Motor frontRightMotor;
        hal::motor::Motor rearLeftMotor;
        hal::motor::Motor rearRightMotor;
        ...
        OmniWheeledDevice(const datatype::Axis orientation,
                          ...
                          const hal::motor::Motor& flMotor,
                          const hal::motor::Motor& frMotor,
                          const hal::motor::Motor& rlMotor,
                          const hal::motor::Motor& rrMotor)
