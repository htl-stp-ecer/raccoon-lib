...
#include "device/omni_wheeled/omni_wheeled_calibration.h"
...
namespace libstp::device::omni_wheeled
{
    inline void createOmniWheeledBindings(py::module_& m)
    {
        py::class_<OmniWheeledDevice, Device, std::shared_ptr<OmniWheeledDevice>>(m, "OmniWheeledNativeDevice", R"pbdoc(
            ...
            .def(py::init<datatype::Axis, datatype::Direction, const hal::motor::Motor&, const hal::motor::Motor&, const
                          hal::motor::Motor&, const
                          hal::motor::Motor&>(),
                 py::arg("orientation"),
                 py::arg("direction"),
