...
class CalibrateAnalogSensor(CalibrateStep[AnalogSensorCalibration]):
    ...
    Example::
        ...
        from libstp.step.calibration import calibrate_analog_sensor
    ...
    async def _collect(
        ...
        from libstp.ui.screens.analog_sensor import (
    ...
    async def _confirm(
        ...
        from libstp.ui.screens.analog_sensor import AnalogSensorConfirmScreen
